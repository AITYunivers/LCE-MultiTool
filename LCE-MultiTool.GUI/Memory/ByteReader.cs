...
namespace LCE_MultiTool.GUI.Memory
{
    public class ByteReader : BinaryReader
    {
        ...
        public string ReadAutoYunicode_16b()
        {
            return ReadYunicode(ReadUShort());
        }

        public string ReadAutoYunicode_32b()
        {
            return ReadYunicode(ReadInt());
        }

        public string ReadAutoAscii()
        {
            return ReadAscii(ReadUShort());
        }

        public string ReadAutoUTF8_16b()
        {
            return ReadUTF8(ReadUShort());
        }

        public string ReadAutoUTF8_32b()
        {
            return ReadUTF8(ReadInt());
        }
